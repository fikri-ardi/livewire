<aside class="bg-gradient-to-b from-gray-900 to-gray-800 h-screen text-gray-200 shadow-lg py-5">
    ...
    <ul>
        <x-li class="border-t-2" active="{{ request()->segment(1) == '' }}">
            <a href="{{ route('home') }}" class="py-3 flex items-center justify-center">
        ...
        <x-li active="{{ request()->segment(1) == 'users' }}">
            <a href="{{ route('users') }}" class="py-3 flex items-center justify-center">
        ...
        <x-li active="{{ request()->segment(1) == 'wallets' }}">
            <a href="{{ route('wallets') }}" class="py-3 flex items-center justify-center">
        ...
        <x-li active="{{ request()->segment(1) == 'stats' }}">
            <a href="{{ route('stats') }}" class="py-3 flex items-center justify-center">
        ...
        <x-li active="{{ request()->segment(1) == 'activities' }}">
            <a href="{{ route('activities') }}" class="py-3 flex items-center justify-center">
